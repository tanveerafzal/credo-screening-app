      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center gap-1">
            ...
            <Link href="/products" className="px-3 py-2 text-sm font-medium text-text-secondary hover:text-text-primary hover:bg-surface-elevated rounded-lg transition-colors">Products</Link>
            <Link href="/id-verification" className="px-3 py-2 text-sm font-medium text-text-secondary hover:text-text-primary hover:bg-surface-elevated rounded-lg transition-colors">ID Verification</Link>
      ...
      {mobileOpen && (
        <div className="md:hidden border-t border-border bg-surface max-h-[80vh] overflow-y-auto">
          <div className="px-4 py-4 space-y-1">
            <div className="text-xs font-semibold text-text-muted uppercase tracking-wider px-3 pt-2 pb-1">Solutions</div>
            {SOLUTIONS_LIST.map((s) => (
              <Link
                key={s.slug}
                href={`/solutions/${s.slug}`}
            ...
            <div className="pt-4 mt-4 border-t border-border space-y-1">
              <Link href="/products" className="block px-3 py-2.5 text-sm font-medium text-text-secondary hover:bg-surface-elevated rounded-lg" onClick={() => setMobileOpen(false)}>Products</Link>
              <Link href="/id-verification" className="block px-3 py-2.5 text-sm font-medium text-text-secondary hover:bg-surface-elevated rounded-lg" onClick={() => setMobileOpen(false)}>ID Verification</Link>
