...
export const JOBS: Job[] = [
  {
    ...
    responsibilities: [
      ...
      'Run product demos and discovery calls, translating compliance pain points into Credo solutions',
      ...
      'Represent Credo at industry events, conferences, and webinars focused on compliance, AML, and KYC',
    ],
    requirements: [
  ...
  },
  {
    ...
    whyJoin: [
      { title: 'Own the program', desc: 'You\'ll define and build Credo\'s security and privacy program from the ground up.' },
